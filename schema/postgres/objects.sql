...
(
    ...
    WEIGHT            numeric,
		...
		CONSTRAINT "VENDOR_PRODUCT_FK_TYPE" FOREIGN KEY (PRODUCT_TYPE_ID) REFERENCES PRODUCT_TYPE(ID)
);
...
(
    ...
    COUNTRY_ID integer NOT NULL,
		...
		CONSTRAINT "FK_CLIENT_1" FOREIGN KEY (COUNTRY_ID) REFERENCES COUNTRY( COUNTRY_ID)
);
...
(
    ...
    ALTERNATIVE_SHIP_DATE date, 
		...
		CONSTRAINT "FK_CLIENT_ORDER_ITEM_3" FOREIGN KEY (CURRENCY_ID) REFERENCES CURRENCY (CURRENCY_ID)
);